...
- 웹 접근성: 신체적, 정신적 특서에 따른 차이 없이 정보에 접근할 수 있는 정도를 측정하는 기준
...
>
> 웹 표준이 웹 접근성을 높이는 데 도움이 되는 것은 사실이지만, 완벽히 보장해 주는 것은 아님!
>
> WAI-ARIA → W3C에서 발표한 기술 명세로, 접근성 및 상호 운용성을 향상
>
> - [웹 접근성 준수를 통한 모두에게 배달되는 일상의 행복](https://techblog.woowahan.com/15541/)
> - [HTML 랜드마크 역할을 사용하여 접근성 향상시키기](https://velog.io/@sejinkim/HTML-%EB%9E%9C%EB%93%9C%EB%A7%88%ED%81%AC-%EC%97%AD%ED%95%A0%EC%9D%84-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-%EC%A0%91%EA%B7%BC%EC%84%B1-%ED%96%A5%EC%83%81%EC%8B%9C%ED%82%A4%EA%B8%B0)
...
> [!NOTE]
>
> - `getByRole`에 사용할 수 있는 `role` 요소
> - 테스팅 라이브러리 쿼리 우선 순위 - https://testing-library.com/docs/queries/about/#priority
...
![image.png](attachment:a3043b65-bb51-4b09-b4da-766bc6317b59:image.png)
